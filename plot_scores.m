...
acceleration_time1 = acceleration(246.063, c1, e1, a1); % all times in seconds
skidpad_time1 = skidpad(60, c1, t1);

acceleration_time2 = acceleration(246.063, c2, e2, a2); % all times in seconds
skidpad_time2 = skidpad(60, c2, t2);

acceleration_time3 = acceleration(246.063, c3, e3, a3); % all times in seconds
skidpad_time3 = skidpad(60, c3, t3);


%% Plot Results
p = plotter();
p.velocity_comparision(e1, c1, a1, e2, c2, a2, e3, c3, a3);
